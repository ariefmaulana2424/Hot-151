...
print (" ")
print (" Total Test Case : ", max_count)
print ("----------------------")    

for x in range(1,len(list_msisidn_B)):
	list_row_extract      = list_row[x]
	print ("ini test case ke - ",list_row_extract)
	print ("")
	...
	if str(list_msisidn_B[x])[0:5] == '62817' or str(list_msisidn_B[x])[0:5] == '62818' or str(list_msisidn_B[x])[0:5] == '62819' or str(list_msisidn_B[x])[0:5] == '62859' or str(list_msisidn_B[x])[0:5] == '62877' or str(list_msisidn_B[x])[0:5] == '62878':
		...
		if (list_trx_date[x] is not None and date_based_on_index_list_min is not None ) and (list_trx_date[x] == date_based_on_index_list_min):
			...
			if list_ir_date_datetime >= list_trx_date_datetime:
				...
				if list_package_price[x] >= 25000 and list_type_paket[x] == 'Non Flash Sale':
					...
					#Validasi 5 check point							
					if list_point[x] == 50000 and validasi1 == 1 and validasi2 == 1 and validasi3 == 1 and validasi4 == 1:
				...
				#elif validasi 4
				elif (list_package_price[x] >= 25000 and list_type_paket[x]=='Flash Sale' and list_point[x] == 0) or (list_package_price[x] <= 25000 and  list_type_paket[x]=='Flash Sale' and list_point[x] == 0):
					wildcard = 1
					#print ("ini wilcard")
					#print ("")			
			...
			#elif validasi 3
			elif list_ir_date_datetime < list_trx_date_datetime and list_point[x] == 0:
				wildcard = 1
				#print ("ini wildcard")
				#print ("")
		...
		#elif validasi 2
		elif (list_trx_date[x] != date_based_on_index_list_min and list_point[x] == 0) or ((list_trx_date[x] == date_based_on_index_list_min) and list_point[x] == 0):
			wildcard = 1
			#print ("ini wildcard")
			#print("")
	...
	if ( validasi1 == 1 and validasi2 == 1 and validasi3 == 1 and validasi4 == 1 and validasi5 == 1 or wildcard ==1) and x != max_count:
		print("PASSED")
		print("")
		message=["Passed"]
	...
	elif ( validasi1 and validasi2 and validasi3 and validasi4 and validasi5 == 1  or wildcard ==1):
		print("PASSED")
		print("")
		message=["Passed"]
		for row, entry in enumerate(message, start=1):
